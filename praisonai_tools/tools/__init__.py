...
# Backward-compatible alias. The catalogue/discovery contract in
# ``praisonai_tools.catalogue`` enumerates shipped tools via ``_TOOL_MAP``
# (name -> module). It is now derived from the auto-discovered manifest so the
# two can never drift apart.
_TOOL_MAP = _TOOL_MANIFEST
