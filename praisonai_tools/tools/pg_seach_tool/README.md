...
## Installation
To install the `praisonai_tools` package and utilize the PGSearchTool, execute the following command in your terminal:
...
```python
from praisonai_tools import PGSearchTool
