...
assert(
  'awaiting merge gate after bot review comment',
  ps.deriveStage(
    [
      { user: { login: 'coderabbitai[bot]' }, body: 'review summary' },
      finalComment,
    ],
...
assert('review bot logins configured', config.reviewBotLogins.includes('coderabbitai[bot]'));
assert(
  'merge ready',
