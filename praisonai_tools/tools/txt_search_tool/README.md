...
## Installation
To use the TXTSearchTool, you first need to install the praisonai_tools package. This can be done using pip, a package manager for Python. Open your terminal or command prompt and enter the following command:
...
```python
from praisonai_tools import TXTSearchTool
