...
## Installation
To get started with the PDFSearchTool, first, ensure the praisonai_tools package is installed with the following command:
...
```python
from praisonai_tools import PDFSearchTool
