...
## Installation
To start using the XMLSearchTool, you must first install the praisonai_tools package. This can be easily done with the following command:
...
```python
from praisonai_tools.tools.xml_search_tool import XMLSearchTool
