...
## Installation
To utilize the YoutubeChannelSearchTool, the `praisonai_tools` package must be installed. Execute the following command in your shell to install:
...
```python
from praisonai_tools import YoutubeChannelSearchTool
